...
// Uint8s converts uint8 slice to uint32 slice.
...
func (u Uint8Slice) Reduce(
	fn func(curr Uint8Slice, k int, v uint8, accumulator uint8) uint8, initialValue ...uint8,
) uint8 {
	if len(u) == 0 {
		return 0
	}
